<?php
/* * *****************************************************************************************************************************************
 * File Name: gb_samplegroupadd.php
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
...
<form name="main_form" id="main_form" action="../../Includes/QC/gb_qcsamplegroupadd.php" onsubmit="return validateForm()" method="post">
...
<script>
    ...
    function loadPlantSelect() {
        ...
        if (siteId.length > 0) {
            ...
            //get the content
            xmlhttp2.open("GET", "../../Includes/QC/gb_plantsselectbysite.php?siteId=" + siteId + "&plantId=" +<?php echo $plantId; ?>, true);
            xmlhttp2.send();
    ...
    function loadLocationSelect() {
        ...
        if (plantId.length > 0) {
            ...
            //get the content
            xmlhttp2.open("GET", "../../Includes/QC/gb_locationslistbyplant.php?plantId=" + plantId + "&locationId=" +<?php echo $locationId; ?>, true);
            xmlhttp2.send();
    ...
    function confirmSite() {
        ...
        if (siteIDSelected != 10) {
            confirm("The Site is not set to Granbury. Are you sure?");
        }
    }
