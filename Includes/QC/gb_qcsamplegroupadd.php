...
/* * *****************************************************************************************************************************************
 * File Name: gb_qcsamplegroupadd.php
 * Project: Silicore
 ...
 * =========================================================================================================================================
 * 06/26/2017|mnutsch|KACE:17366 - Initial creation
 * 07/25/2017|mnutsch|KACE:17366 - Added functionality to also insert records into Back Office.
 * 08/03/2017|mnutsch|KACE:17803 - Added REST parameter to redirect on success.
 * 08/14/2017|mnutsch|KACE:xxxxx - Added parameter to redirect
 * 08/22/2017|mnutsch|KACE:17957 - Removed code and references to Back Office. 
 * Samples are now inserted into Back Office when they are edited.
...
if($isValidationError == 1)
{
  ...
  //redirect the user 
  header('Location: ../../Controls/QC/gb_samplegroupadd.php?validationStatus=fail');
}
...
try
{
  ...
  $sql = "CALL sp_gb_qc_ShiftsGetBySiteAndDate(" . $plantId . ",'" . $dt . "');";
...
for($j = 0; $j < $numberOfGroups; $j++)
{
  ...
  for($i = 0; $i < $locationCount; $i++)
  {	
    //insert the values into the samples table
...
if($siteId != 10) //siteID 10 = Granbury, 50 = Tolar
{
  $siteObject = getSiteById($siteId);
  $sendExternalQCSampleNotificationResult = sendExternalQCSampleNotification(0, $siteObject->vars['description'], $sampleIDs, "Granbury");
}
...
header('Location: ../../Controls/QC/gb_samples.php?view=summary&completionStatus=Incomplete');
