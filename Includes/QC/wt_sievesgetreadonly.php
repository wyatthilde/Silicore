...
if($debugging == 1)
{
    ...
    echo "<strong>Debugging Enabled - wt_sievesget.php</strong><br/>";
}
//read the input values from the form
$stackId = test_input($_GET['stackId']);
$sampleId = test_input($_GET['sampleId']);
$database = new Database();
$is_complete_read = $database->get('sp_wt_qc_IsCompleteSampleGet("' . $sampleId . '");');
...
<td>
    <input type="number"  class="form-control sieveRequired" step="0.0001" max="9999999" id="finalWeight' . $objectCounter . '" name="finalWeight' . $objectCounter . '" value="' . $tempFinalWeight . '" onchange="calculateTotalFinalWeight(); calculateRates(); changeBlankSieveRangesToNA();" disabled>
</td>
<td>
...
<td>
<input type="number" class="form-control sieveRequired" step="0.0001" max="9999999" id="startWeight' . $objectCounter . '" name="startWeight' . $objectCounter . '" value="' . $startWeight . '"  onchange="calculateFinalWeight(\'' . $objectCounter . '\'); calculateRates(); changeBlankSieveRangesToNA();" disabled>
</td>
<td>
<input type="number" class="form-control sieveRequired" step="0.0001" max="9999999" id="endWeight' . $objectCounter . '" name="endWeight' . $objectCounter . '" value="' . $tempEndWeight . '"  onchange="calculateFinalWeight(\'' . $objectCounter . '\'); calculateRates(); changeBlankSieveRangesToNA();" disabled>
</td>
<td>
...
<style>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-lg-1">
            <label for="neg10Plus40">-10 +40:</label>
            <input class="form-control" type="text" id="neg10Plus40" name="neg40Plus70" readonly>
        </div>
        <div class="form-group col-lg-1">
