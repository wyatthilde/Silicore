...
<div class="container pl-0 pr-0">
    ...
    <div class="card mt-4 mb-4 bg-secondary text-white text-center">
...
<script>
    ...
    function generateSilos(){
        ...
        let cardStart = '<div class="card text-white bg-secondary mb-3 text-center">';
        let cardHeader = '<div class="card-header"><h4>Silo '+silo+'</h4></div>';
        let cardBody = '<div class="card-body"><div class="outer-wrapper"><div class="top"><div class="badge badge-secondary display-5 percentage-silo'+silo+' rounded-0">--</div></div>';
