...
--
-- Table structure for table `ui_gauge_configuration`
--
...
--
-- Dumping data for table `ui_gauge_configuration`
--

LOCK TABLES `ui_gauge_configuration` WRITE;
/*!40000 ALTER TABLE `ui_gauge_configuration` DISABLE KEYS */;
/*!40000 ALTER TABLE `ui_gauge_configuration` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:54:22
