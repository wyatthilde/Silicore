 ...
 * 01/10/2018|mnutsch|KACE:xxxxx - Corrected a snippet of code to look at Tolar permission instead of tolar.
  ...
  if($view != "verbose")
  {
    ...
    else 
    {
      //Display the Verbose version of the table.
            ...
            if(isset($userPermissionsArray['vista']['tolar']['qc']))
            {
                if($userPermissionsArray['vista']['tolar']['qc'] > 0) //if the user has QC permission then show them the hyperlinks
                {
            ...
            foreach ($ObjectArray as $Object)
            {
              ...
              if($Object->vars["isCOA"] != NULL)
              {
                ...
                echo "<tr>" .
                    "<td class='leftCol2' title='Sample ID'><a href='../../Controls/QC/tl_sampleview.php?sampleId=" . $Object->vars["id"] . "'>" . $Object->vars["id"] . "</a></td>" .
                ...
                if(isset($userPermissionsArray['vista']['tolar']['qc']))
                {
                    if($userPermissionsArray['vista']['tolar']['qc'] > 0) //if the user has a QC permission then show them the edit link
                    {
                        $i++; //increment the counter for dynamic fixed CSS placement
                        echo "<td>";//summary field
                        echo "<a href='../../Controls/QC/tl_sampleedit.php?sampleId=" . $Object->vars["id"] . "'>Edit</a>";
                        echo "</td>";
                    }
                    else {
                        $i++; //increment the counter for dynamic fixed CSS placement
                ...
                if(isset($userPermissionsArray['vista']['tolar']['qc']))
                {
                    if($userPermissionsArray['vista']['tolar']['qc'] > 0) //if the user has a QC permission then show them the void link
                    {
                        ...
                        else
                        {
                            ...
                            if(isset($userPermissionsArray['vista']['tolar']['qc']))
                            {
                                if($userPermissionsArray['vista']['tolar']['qc'] >= 3)
                                {
                                    echo "<a href='../../Includes/QC/tl_samplereversevoid.php?sampleId=" . $Object->vars["id"] . "&completionStatus=" . $completionStatus . "&startDate=" . $startDate . "&endDate=" . $endDate . "&startRow=" . $startRow . "&resultsPerPage=" . $resultsPerPage . "&compositeType=" . $compositeType . "&shift=" . $shift . "&sampler=" . $sampler . "&operator=" . $operator . "&view=" . $view . "&void=" . $void . "&locationsRESTString=" . $locationsRESTString . "&testTypesRESTString=" . $testTypesRESTString . "&labTechsRESTString=" . $labTechsRESTString . "&sitesRESTString=" . $sitesRESTString . "&plantsRESTString=" . $plantsRESTString . "&specificLocationsRESTString=" . $specificLocationsRESTString . "&isCOA=" . $isCOA . "' onclick=\"return confirm('Are you sure?')\">UnVoid</a>";
                                }
                            }
                            else
                            {
    ...
    else
    {
        ...
        echo "<th class='col7 headContent headContentNotLeft'>Shift</th>" . //summary field
          ...
          echo "<th class='verbose col11 headContent headContentNotLeft'>+10(OS)</th>" .
              "<th class='verbose col11 headContent headContentNotLeft'>-10+40</th>" .
          "<th class='verbose col12 headContent headContentNotLeft'>-40+70</th>" .
          "<th class='verbose col12 headContent headContentNotLeft'>-60+70</th>" .
          "<th class='verbose col12 headContent headContentNotLeft'>-70+140</th>" .
          "<th class='verbose col13 headContent headContentNotLeft'>-50+140</th>" .
          "<th class='verbose col14 headContent headContentNotLeft'>Near Size</th>" .
          "<th class='verbose col15 headContent headContentNotLeft'>-140+325</th>" .
...
<script>
    ...
    function idSearch()
    {
        ...
        window.location = "tl_sampleedit.php?sampleId=" + idInput;
    }
