 ...
 * 06/06/2019|whildebrandt|KACE:30509 - fixed bug regarding checking how to add to pan values when a core sample. It was being checked by looking at the literal text in location box instead of using the checkIfCoreSample() function
 * **************************************************************************************************************************************** */
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0" id="oversizeWeight"
                                       ...
                                       onChange="updateOversizePercent(); setLostValues();calculateOrePercent(); calculateRates();">
...
<script>
    ...
    function calculateOrePercent() {
        ...
        var oversizePercent = oversizeWeight/preWashDryWeight;
        ...
        if ((preWashDryWeight == 0) || (postWashDryWeight == 0)) {
            ...
            orePercentValue = parseFloat(postWashDryWeight / preWashDryWeight - oversizePercent); //initially round to 4 decimal places while a decimal
    ...
    function setLostValues() {
        ...
        var percentLost = 1 - ((parseFloat(postWashWeight) + parseFloat(oversizeWeight)) / parseFloat(preWashDryWeight));
        percentLost = percentLost < 0 ? 0 : percentLost;
    ...
    function calculateRates() {
        ...
        var splitWeight = document.getElementById("splitSampleWeight").value;
        ...
        for (i = 1; i < sieveCount; i++) //iterate through all sieves
        {
            ...
            if (checkIfCoreSample()) //if this is a core sample then use the regular weight * ore percent
            {
                ...
                {
                    if(oversizeWeight === "0" || oversizeWeight === 0 || oversizeWeight === "") {
                        itemFinalPercentFirstPass = parseFloat(document.getElementById('finalWeight' + i).value) * orePercentValueAsNumber /  parseFloat(totalFinalWeightForCalc);
                        console.log(oversizeWeight);
                    } else {
                        itemFinalPercentFirstPass = parseFloat(document.getElementById('finalWeight' + i).value) * orePercentValueAsNumber /  parseFloat(newSplit);
        ...
        if (checkIfCoreSample()) {
            ...
            newPan = parseFloat(percentToAddToPan) + parseFloat(panPercentageFirstPass) - parseFloat($('#oversizePercent').val()) / 100;
