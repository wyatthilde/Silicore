<?php
/* * *****************************************************************************************************************************************
 * File Name: wt_samplegroupadd.php
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
...
<form name="main_form" id="main_form" action="../../Includes/QC/wt_qcsamplegroupadd.php" onsubmit="return validateForm()" method="post">
...
<script>
    ...
    function loadPlantSelect() {
        ...
        if (siteId.length > 0) {
            ...
            //get the content
            xmlhttp2.open("GET", "../../Includes/QC/wt_plantsselectbysite.php?siteId=" + siteId + "&plantId=" +<?php echo $plantId; ?>, true);
            xmlhttp2.send();
    ...
    function loadLocationSelect() {
        ...
        if (plantId.length > 0) {
            ...
            //get the content
            xmlhttp2.open("GET", "../../Includes/QC/wt_locationslistbyplant.php?plantId=" + plantId + "&locationId=" +<?php echo $locationId; ?>, true);
            xmlhttp2.send();
    ...
    function confirmSite() {
        ...
        if (siteIDSelected != 60) {
            confirm("The Site is not set to West Texas. Are you sure?");
        }
    }
