...
--
-- Table structure for table `prod_auto_plant_analog_data`
--
...
--
-- Dumping data for table `prod_auto_plant_analog_data`
--

LOCK TABLES `prod_auto_plant_analog_data` WRITE;
/*!40000 ALTER TABLE `prod_auto_plant_analog_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `prod_auto_plant_analog_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:53:39
