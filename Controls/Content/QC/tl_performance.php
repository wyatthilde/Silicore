...
else
{
  ...
  if(($userIsLabTech == 1) && ($userPermissionsArray['vista']['tolar']['qc'] < 3))
  {
    //read the data for the cycles table
...
<?php
  ...
  echo "<br/><br/>";
  echo("DEBUG: Night Shift:<br/>");
  echo("DEBUG: count(arrayOfDatesObjects_Night) = " . count($arrayOfDatesObjects_Night) . "<br/>");
  echo("data.addRows([");
