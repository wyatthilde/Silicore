...
<script type="text/javascript" src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.18/b-1.5.2/b-flash-1.5.2/b-html5-1.5.2/fc-3.2.5/fh-3.1.4/r-2.2.2/sl-1.2.6/datatables.min.js"></script>
...
<div id="qc_groups" class="tabcontent">
  ...
  <div id="filter_options" class="filter_options">
    ...
    <fieldset>
      ...
      <br/>      
      <button id="clearFilters" class="applyFilters" type="button" onclick="clearFilters()">Clear Filters</button><br/><br/>
      <button style="color:white; background-color: #003087;" id="applyFilters" class="applyFilters" type="button" onclick="reloadPage()">Apply Filters</button><br/><br/>
  ...
  ?>
    Go To Sample ID: <input type='number' pattern="[0-9]" id='idSearchBox' required>
    <button style="width:150px;"onclick="idSearch()" type="button" >Submit</button>

  <h4>Summations</h4>
  <div class="tableWrapper">
  <table class="table table-striped table-bordered dt-responsive summationsTable summationsTable">
  ...
  if($view != "verbose")
  {
    ...
    else 
    {
      //Display the Verbose version of the table.
          ...
          echo("<table id='samplesTable' name='samplesTable' class='table table-striped table-bordered'>");

            //get a list of PLC Tags to display as columns
            $PLCArray = getPLCTags();
            echo("<thead>");
            echo "<tr>" .
            "<th name='tableHeaderCheckCell' id='tableHeaderCheckCell' class='sorter-false leftHead1 headContent' data-sorter='false'>Select All<br/><input name='tableHeaderCheck' id='tableHeaderCheck' type='checkbox' value='1' onclick='toggleCheckAll()'></th>" .         
            ...
            foreach ($ObjectArray as $Object) 
            {
              ...
              "<td class='leftCol1' title='Select for Download'><input type='checkbox' name='tableRowCheckbox' id='tableRowCheckbox" . $l . "' value='1' onchange='readTableContentsToDownload();'></td>" .

              "<td class='leftCol2' title='Sample ID'><a href='../../Controls/QC/gb_sampleview.php?sampleId=" . $Object->vars["id"] . "'>" . $Object->vars["id"] . "</a></td>" .  //summary field
              "<td class='leftCol3' title='Date'>" . $Object->vars["date"] . "</td>" .  //summary field
              "<td class='leftCol4' title='Time'>" . $Object->vars["time"] . "</td>"; //summary field
  ...
  else
  {
    //Display the table in Verbose format
        ...
        echo("<table id='samplesTable' name='samplesTable' class='table table-striped table-bordered'>");
          ...
          "<th class='col5 headContent headContentNotLeft'>Location</th>"; //summary field   
          ...
          echo "<th class='verbose col11 headContent headContentNotLeft'>Plus Seventy (+70)</th>" . 
          "<th class='verbose col12 headContent headContentNotLeft'>Minus Seventy -70</th>" . 
          "<th class='verbose col13 headContent headContentNotLeft'>Minus Seventy Plus One Forty (-70 +140)</th>" . 
          "<th class='verbose col14 headContent headContentNotLeft'>Minus One Forty (-140)</th>" . 
          "<th class='verbose col15 headContent headContentNotLeft'>Minus Forty Plus Seventy (-40 +70)</th>";

          echo "<th class='verbose col16 headContent headContentNotLeft'>Beginning Wet Weight</th>" . 
          "<th class='verbose col17 headContent headContentNotLeft'>Pre Wash Dry Weight</th>" . 
          "<th class='verbose col18 headContent headContentNotLeft'>Post Wash Dry Weight</th>" . 

          "<th class='verbose col19 headContent headContentNotLeft'>Split Sample Weight</th>" . 
          "<th class='verbose col20 headContent headContentNotLeft'>Turbidity</th>" . 
          "<th class='verbose col21 headContent headContentNotLeft'>Tons Represented</th>" . 
          "<th class='verbose col22 headContent headContentNotLeft'>TPH Represented</th>";

          echo "<th class='col23 headContent headContentNotLeft'>Notes</th>" . //summary field
          "<th class='col24 headContent headContentNotLeft'>Moisture Rate</th>"; //summary field      

          echo "<th class='verbose col25 headContent headContentNotLeft'>Recovery +140</th>" . 
          "<th class='verbose col26 headContent headContentNotLeft'>Group Start Datetime</th>" . 
          "<th class='verbose col27 headContent headContentNotLeft'>Finish Datetime</th>" . 
          "<th class='verbose col28 headContent headContentNotLeft'>Duration Minutes</th>" . 
          "<th class='verbose col29 headContent headContentNotLeft'>Duration</th>" . 

          "<th class='verbose col30 headContent headContentNotLeft'>Total Weight</th>"; 
   
          echo("<th class='col31 headContent headContentNotLeft'>Void Status</th>"); //summary field      
          echo("<th class='col32 headContent headContentNotLeft'>Completion Status</th>"); //summary field    

          echo "<th class='col33 headContent headContentNotLeft'>Site</th>"; //summary field  

          echo "<th class='verbose col34 headContent headContentNotLeft'>Drillhole Number</th>" . 
          "<th class='verbose col35 headContent headContentNotLeft'>Depth From</th>" . 
          "<th class='verbose col36 headContent headContentNotLeft'>Depth To</th>";

          echo "<th class='verbose col37 headContent headContentNotLeft'>Oversize Weight</th>";
          echo "<th class='verbose col38 headContent headContentNotLeft'>Oversize Percent</th>";
          echo "<th class='verbose col39 headContent headContentNotLeft'>Slimes Percent/Amt Lost in Wash</th>";
          echo "<th class='verbose col40 headContent headContentNotLeft'>Ore Percent</th>";
          echo "<th class='verbose col41 headContent headContentNotLeft'>Is COA</th>";
          echo "<th class='verbose col42 headContent headContentNotLeft'>Description</th>";

          echo "<th class='verbose col43 headContent headContentNotLeft'>Near Size</th>" . 

          "<th class='verbose col44 headContent headContentNotLeft'>30</th>" . 	
          "<th class='verbose col45 headContent headContentNotLeft'>35</th>" . 	
          "<th class='verbose col46 headContent headContentNotLeft'>40</th>" . 	
          "<th class='verbose col47 headContent headContentNotLeft'>45</th>" . 	
          "<th class='verbose col48 headContent headContentNotLeft'>50</th>" . 	
          "<th class='verbose col49 headContent headContentNotLeft'>60</th>" . 	
          "<th class='verbose col50 headContent headContentNotLeft'>70</th>" . 	
          "<th class='verbose col51 headContent headContentNotLeft'>80</th>" . 	
          "<th class='verbose col52 headContent headContentNotLeft'>100</th>" . 	
          "<th class='verbose col53 headContent headContentNotLeft'>120</th>" . 	
          "<th class='verbose col54 headContent headContentNotLeft'>140</th>" . 	
          "<th class='verbose col55 headContent headContentNotLeft'>170</th>" . 	
          "<th class='verbose col56 headContent headContentNotLeft'>200</th>" . 	
          "<th class='verbose col57 headContent headContentNotLeft'>230</th>" . 	
          "<th class='verbose col58 headContent headContentNotLeft'>270</th>" . 	
          "<th class='verbose col59 headContent headContentNotLeft'>325</th>" . 	
          "<th class='verbose col60 headContent headContentNotLeft'>PAN</th>";
          ...
          foreach ($ObjectArray as $Object) 
          {
            ...
            echo "<td class='verbose' title='Group Time'>" . $Object->vars["groupTime"] . "</td>";
  ...
  <?php
    ...
    else 
    {
      ...
      echo("<table class='table table-striped table-bordered dt-responsive nowrap summationsTable'>");
...
{ 
  ...
  var selectAllCheckBox = document.getElementById("tableHeaderCheckCell");  
  selectAllCheckBox.addEventListener("click", stopPropagation);

// prevents a conflict with jquery and select all box being displayed inaccurately
