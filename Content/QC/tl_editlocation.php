...
function getPlants()
{
  ...
  try
  {
    ...
    $sql = "CALL sp_GetPlants();"; // Stored procedure method, which returns a list of all possible location plants. *Did not implement filter for this edit form because I have the site pre-selected here from tl_managelocations.php and that messed up the AJAX script.
...
<html>
      ...
      <body>
          <h1>Edit Location</h1><br /><br />
                ...
                <div class="container">
                <form action="tl_updatelocation.php" method="GET">
