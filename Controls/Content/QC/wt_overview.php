 ...
 * 01/10/2018|mnutsch|KACE:19775 - Corrected a value to default to West Texas instead of Tolar.
 * 
 * **************************************************************************************************************************************** */
...
if(isset($_GET['siteId']))
{
  ...
  if($siteId == "")
  {
    //if the siteId parameter received is empty, then default it to West Texas (ID # 60)
    $siteId = 60;
  }
}
else 
{
  //if there isn't a siteId parameter received, then default it to West Texas (ID # 60)
  $siteId = 60;
}
