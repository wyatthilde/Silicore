/*******************************************************************************************************************************************
 * File Name: sp_tl_qc_RepeatabilitySamplePairsGetByLabTech.sql
 * Project: smashbox
 * Description: 
 * Notes:
 * =========================================================================================================================================
...
DELIMITER $$
DROP PROCEDURE IF EXISTS sp_tl_qc_RepeatabilitySamplePairsGetByLabTech$$
...
BEGIN
    ...
    FROM tl_qc_repeatability_pairs AS pairs 
