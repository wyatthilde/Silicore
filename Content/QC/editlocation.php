...
<html>
      ...
      <body>
          <h1>Edit Location</h1><br /><br />
                ...
                <div class="container">
                <form action="updatelocation.php" method="GET">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                        echo '<input type="number" class="form-control" id="orderTextbox" name="orderTextbox" value="' . $locationOrder .'" max="99999" required>';
                    ?>
                </div>
