...
require_once('../../Includes/QC/wt_qcfunctions.php');
...
function getSpecificLocationNames()
{
    ...
    try {
        ...
        $result = $mySQLConnectionLocal->query("CALL sp_wt_qc_LocationDetailsByNameGet();"); //stored procedure method
...
<div class="container">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="siteSelect" id="siteSelect" readonly>
                ...
                foreach ($siteObjectArray as $siteObject) {
                    if ($siteObject->vars["id"] == 60) // If the row's ID corresponds to "Granbury" (ID: 60).
                    {
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="locationSelect" id="locationSelect" required>
                ...
                foreach ($locationObjectArray as $locationObject) {
                    if ($locationObject->vars["site"] == 60) // If the row's ID corresponds to "Granbury" (ID: 60).
                    {
    ...
    <table class="table table-fluid table-striped table-hover" id="specificLocationsTable">
        ...
        foreach ($specificspecificObjectArray as $specificObject) {
            ...
            $editURL = "../../Controls/QC/wt_editspecificlocation.php?specificID=" . urlencode($specificObject->vars['id']) .
