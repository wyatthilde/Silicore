<?php
/* * *****************************************************************************************************************************************
 * File Name: sievestackselectbysitereadonly.php
 * Project: Silicore
...
//include other files
require_once('../../Includes/QC/tl_qcfunctions.php'); //contains functions related to QC<?php
...
echo('<select class="form-control" id="sieveStackId" name="sieveStackId" onChange="getSieves()" disabled>');
echo('<option value=""></option>');

$query = 'sp_tl_qc_SieveStackGetByID("' . $sieveStackID . '")';
