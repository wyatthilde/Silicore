/*******************************************************************************************************************************************
 * File Name: sp_tl_qc_DateRangePercentSamplesGet.sql
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
...
DROP PROCEDURE IF EXISTS sp_tl_qc_DateRangePercentSamplesGet;

DELIMITER //

CREATE DEFINER=`root`@`localhost` PROCEDURE sp_tl_qc_DateRangePercentSamplesGet
(
