...
$sql = "CALL sp_wt_qc_LocationInsert('$description', $main_site_id, $main_plant_id, $is_split_sample_only, $user_id);"; // Inserts new location into gb_qc_locations table.

$result = $mySQLConnection->query($sql);

disconnectFromMySQLQC($mySQLConnection); // Disconnect from database.

echo "<script type=\"text/javascript\">window.location = \"../../Controls/QC/wt_samplelocations.php\";</script>"; // Using JS, because output is already sent in header.php...
