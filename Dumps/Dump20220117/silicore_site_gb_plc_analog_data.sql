...
--
-- Table structure for table `gb_plc_analog_data`
--
...
--
-- Dumping data for table `gb_plc_analog_data`
--

LOCK TABLES `gb_plc_analog_data` WRITE;
/*!40000 ALTER TABLE `gb_plc_analog_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `gb_plc_analog_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 14:01:01
