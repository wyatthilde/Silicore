...
function UpdateSieveStack($id, $siteId, $userId)
{
    ...
    try
    {
        ...
        {
            $sql = "CALL sp_gb_qc_RetireSieveUpdate('" . $id  . "','" . $siteId . "','" . $userId . "');"; //stored procedure method
        ...
        elseif($siteId == 50)
        {
            $sql = "CALL sp_tl_qc_RetireSieveUpdate('" . $id  . "','" . $siteId . "','" . $userId . "');"; //stored procedure method
        ...
        elseif($siteId == 60)
        {
            $sql = "CALL sp_wt_qc_RetireSieveUpdate('" . $id  . "','" . $siteId . "','" . $userId . "');"; //stored procedure method
