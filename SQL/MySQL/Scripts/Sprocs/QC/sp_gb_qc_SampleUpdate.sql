/*******************************************************************************************************************************************
 * File Name: sp_gb_qc_SampleUpdate.sql
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
 ...
 * =========================================================================================================================================
 * 6/05/2017|mnutsch|KACE:xxxxx - Initial creation
 * 10/05/2017|mnutsch|KACE:17957 - Added parameters and renamed.
 * 11/15/2017|mnutsch|KACE:18470 - Added isCOA parameter.
 * 01/26/2018|mnutsch|KACE:20305 - Added Near Size parameter.
 * 03/22/2018|whildebrandt|KACE:21882 - Changed sampler, operator and labtech to only accept int(11) instead of varchar(32).
 ******************************************************************************************************************************************/

USE `silicore_site`;
DROP procedure IF EXISTS `sp_gb_qc_SampleUpdate`;

DELIMITER $$
USE `silicore_site`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_gb_qc_SampleUpdate`(
    IN p_id INT(11),
