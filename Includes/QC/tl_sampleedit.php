...
$query = 'sp_tl_qc_SampleRepeatCheck("' . $sampleId . '");';
$repeatCheck = json_decode($db->get($query))[0];
if ($repeatCheck !== null) {
...
<div class="container" style="max-width:85%;">
    ...
    <script>
        ...
        function confirmSite() {
            ...
            if (siteIDSelected != 50) //DEV NOTE: This site ID is hard coded and should be changed for new mine sites. 10 = tolar; 50 = Tolar
            {
    ...
    <script>
        window.onload(openTab(event, 'qc_general'));
    </script>
