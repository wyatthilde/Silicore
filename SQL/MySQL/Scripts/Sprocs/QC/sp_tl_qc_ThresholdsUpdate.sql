/*******************************************************************************************************************************************
 * File Name: sp_tl_qc_ThresholdsUpdate.sql
 * Project: Silicore
 * Description: update a record in the table tl_qc_thresholds.
 * Notes: Usage example: CALL sp_tl_qc_ThresholdsUpdate('30','54','0.2','0.9');
 * =========================================================================================================================================
...
DROP PROCEDURE IF EXISTS sp_tl_qc_ThresholdsUpdate;
