...
//include other files
require_once('../../Includes/QC/tl_qcfunctions.php'); //contains qc database functions
...
<script type="text/javascript">
    function reloadPage()
    {
        ...
        window.location='tl_performance.php?startDate=' + startDate + '&endDate=' + endDate + '&labTech=' + labTech;
    }
</script>
<?php
$previousDate = NULL;
