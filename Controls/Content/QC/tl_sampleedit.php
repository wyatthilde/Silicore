 ...
 * 01/04/2017|mnutsch|KACE:xxxxx - Switched hard coded defaults from Granbury to Tolar.
...
<form id="qcForm" name="qcForm" action="../../Includes/QC/tl_sampleeditprocess.php" onsubmit="return validateForm()" method="post" autocomplete="off">
...
function confirmSite()
{
  ...
  if(siteIDSelected != 50) //DEV NOTE: This site ID is hard coded and should be changed for new mine sites. 10 = Granbury; 50 = Tolar
  {
