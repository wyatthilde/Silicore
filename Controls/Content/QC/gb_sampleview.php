 ...
 * 08/02/2017|mnutsch|KACE:17366 - Modified which file gets called to populate the Plant Settings tab.
 * 08/03/2017|mnutsch|KACE:17803 - Updated core sample filtering options.
 * 08/04/2017|mnutsch|KACE:17803 - Add REST variable to redirect on button click.
 * 08/04/2017|mnutsch|KACE:17803 - Corrected formulat for field negOneForty
 ...
 * 08/30/2017|mnutsch|KACE:17957 - Made certain fields read only again.
 ...
 * 11/28/2017|mnutsch|KACE:19709 - Fixed a bug involving a missing </div> tag. Cleaned up <div> indentations.
...
{
  echo "<script type=\"text/javascript\">window.location = \"../../Controls/QC/gb_samples.php?void=A&view=verbose&completionStatus=1\";</script>"; //using JS, because output is already sent in header.php
}
else
{
...
<form id="qcForm" name="qcForm" action="../../Includes/QC/gb_sampleeditprocess.php" onsubmit="return validateForm()" method="post">
...
<div id="qc_general" class="tabcontent">
  ...
  <div class="sieveAreaSampleDetail">
    ...
    <button class="qcButtons" type="button" onclick="location.href = '../../Controls/QC/gb_samples.php?void=A&void=A&view=summary';">Back</button>
  </div>
...
<div id="qc_characteristics" class="tabcontent">
  ...
  <button class="qcButtons" type="button" onclick="location.href = '../../Controls/QC/gb_samples.php?void=A&view=summary';">Back</button>
</div>
...
{ 
  ...
  if((document.getElementById('startWeight' + argNumber) !== null) && (document.getElementById('endWeight' + argNumber) !== null))
  {
    ...
    finalWeight = endWeight - startWeight;
    ...
    document.getElementById('finalWeight111' + argNumber).value = finalWeight;
    calculateTotalFinalWeight();
  }
}
...
function setLostValues()
{
  ...
  var percentLost = 1 - ((parseInt(postWashWeight) / parseInt(preWashDryWeight));
...
function calculateRates()
{
  ...
  percentLost = 1 - ((parseInt(postWashWeight) + parseInt(oversizeWeight)) / parseInt(preWashDryWeight));
  //console.log("DEBUG: postWashWeight = " + postWashWeight);
  //console.log("DEBUG: preWashDryWeight = " + preWashDryWeight);
  percentLost = Math.round(percentLost * 10000) / 10000; //round to 4 decimal places
