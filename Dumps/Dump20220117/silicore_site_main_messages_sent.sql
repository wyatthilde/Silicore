...
--
-- Table structure for table `main_messages_sent`
--

DROP TABLE IF EXISTS `main_messages_sent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `main_messages_sent` (
...
--
-- Dumping data for table `main_messages_sent`
--

LOCK TABLES `main_messages_sent` WRITE;
/*!40000 ALTER TABLE `main_messages_sent` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_messages_sent` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:53:42
