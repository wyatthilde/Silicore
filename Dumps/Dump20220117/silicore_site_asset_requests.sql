...
CREATE TABLE `asset_requests` (
  ...
  `kace_ticket` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `KF_employee_id_idx` (`employee_id`),
  CONSTRAINT `KF_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `hr_employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-01-17 13:51:01
