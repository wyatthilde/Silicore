<?php
/* * *****************************************************************************************************************************************
 * File Name: gb_thresholdedit.php
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
...
if($allValuesPresent == 1)
{
  ...
  echo("<form action='../../Includes/QC/gb_thresholdupdate.php' method='get'>");
...
else 
{
  ...
  echo "<script type=\"text/javascript\">window.location = \"../../Controls/QC/gb_thresholdmaint.php\";</script>"; //using JS, because output is already sent in header.php
}
