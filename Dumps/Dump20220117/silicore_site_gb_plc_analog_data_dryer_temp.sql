...
--
-- Table structure for table `gb_plc_analog_data_dryer_temp`
--
...
--
-- Dumping data for table `gb_plc_analog_data_dryer_temp`
--

LOCK TABLES `gb_plc_analog_data_dryer_temp` WRITE;
/*!40000 ALTER TABLE `gb_plc_analog_data_dryer_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `gb_plc_analog_data_dryer_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:56:30
