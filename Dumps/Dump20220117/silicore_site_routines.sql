...
--
-- Temporary view structure for view `gb_qc_plc_DataView`
--

DROP TABLE IF EXISTS `gb_qc_plc_DataView`;
/*!50001 DROP VIEW IF EXISTS `gb_qc_plc_DataView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `gb_qc_plc_DataView` AS SELECT 
 1 AS `id`,
 1 AS `device`,
 1 AS `timestamp`,
 1 AS `value`*/;
...
--
-- Temporary view structure for view `gb_plc_TS_10minute_ArchiveView`
--

DROP TABLE IF EXISTS `gb_plc_TS_10minute_ArchiveView`;
/*!50001 DROP VIEW IF EXISTS `gb_plc_TS_10minute_ArchiveView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `gb_plc_TS_10minute_ArchiveView` AS SELECT 
 1 AS `id`,
 1 AS `timestamp`,
 1 AS `tag_id`,
 1 AS `value`,
...
--
-- Temporary view structure for view `main_plc_tags_view`
--

DROP TABLE IF EXISTS `main_plc_tags_view`;
/*!50001 DROP VIEW IF EXISTS `main_plc_tags_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `main_plc_tags_view` AS SELECT 
 1 AS `id`,
 1 AS `site`,
 1 AS `tag`,
 1 AS `address`,
...
--
-- Temporary view structure for view `gb_plc_production_fuel_view_Sum`
--

DROP TABLE IF EXISTS `gb_plc_production_fuel_view_Sum`;
/*!50001 DROP VIEW IF EXISTS `gb_plc_production_fuel_view_Sum`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `gb_plc_production_fuel_view_Sum` AS SELECT 
 1 AS `id`,
 1 AS `shift_id`,
 1 AS `fuel`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `qc_AllSitesLocationsView`
--

DROP TABLE IF EXISTS `qc_AllSitesLocationsView`;
/*!50001 DROP VIEW IF EXISTS `qc_AllSitesLocationsView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `qc_AllSitesLocationsView` AS SELECT 
 1 AS `id`,
 1 AS `sort_order`,
 1 AS `site_id`,
 1 AS `site`,
 ...
 1 AS `name`,
 1 AS `description`,
 1 AS `is_split_sample_only`,
 1 AS `is_active`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `gb_plc_production_fuel_view`
--

DROP TABLE IF EXISTS `gb_plc_production_fuel_view`;
/*!50001 DROP VIEW IF EXISTS `gb_plc_production_fuel_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `gb_plc_production_fuel_view` AS SELECT 
 1 AS `id`,
 1 AS `shift_id`,
 1 AS `tons`,
 1 AS `product`,
...
--
-- Temporary view structure for view `qc_SievesByIsActiveView`
--

DROP TABLE IF EXISTS `qc_SievesByIsActiveView`;
/*!50001 DROP VIEW IF EXISTS `qc_SievesByIsActiveView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `qc_SievesByIsActiveView` AS SELECT 
 1 AS `id`,
 1 AS `description`,
 1 AS `main_site_id`,
 1 AS `last_cleaned`,
 1 AS `last_cleaned_by`,
 1 AS `is_active`,
 1 AS `is_camsizer`,
 1 AS `create_date`,
 1 AS `create_user_id`,
...
--
-- Temporary view structure for view `qc_locationsView`
--

DROP TABLE IF EXISTS `qc_locationsView`;
/*!50001 DROP VIEW IF EXISTS `qc_locationsView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `qc_locationsView` AS SELECT 
 1 AS `description`,
 1 AS `site`,
 1 AS `plant`,
 1 AS `is_split_sample_only`,
...
--
-- Final view structure for view `gb_qc_plc_DataView`
--
...
/*!50001 VIEW `gb_qc_plc_DataView` AS select `pat`.`id` AS `id`,`pat`.`device` AS `device`,`ts`.`timestamp` AS `timestamp`,`ts`.`value` AS `value` from ((`gb_plc_TS_10minute` `ts` join `gb_plc_tags` `t` on((`t`.`id` = `ts`.`tag_id`))) join `prod_auto_plant_analog_tags` `pat` on((`pat`.`tag_plc` = `t`.`address`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `gb_plc_TS_10minute_ArchiveView`
--
...
/*!50001 SET collation_connection      = utf8_general_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`webdev`@`progdev001` SQL SECURITY DEFINER */
/*!50001 VIEW `gb_plc_TS_10minute_ArchiveView` AS select `gb_plc_TS_10minute`.`id` AS `id`,`gb_plc_TS_10minute`.`timestamp` AS `timestamp`,`gb_plc_TS_10minute`.`tag_id` AS `tag_id`,`gb_plc_TS_10minute`.`value` AS `value`,`gb_plc_TS_10minute`.`quality` AS `quality` from `gb_plc_TS_10minute` where (`gb_plc_TS_10minute`.`timestamp` <= (now() - interval 32 day)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `main_plc_tags_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `main_plc_tags_view` AS select `t`.`id` AS `id`,`s`.`description` AS `site`,`t`.`tag` AS `tag`,`t`.`address` AS `address`,`t`.`ui_label` AS `ui_label`,`t`.`description` AS `description`,`t`.`classification` AS `classification`,`t`.`ehouse` AS `ehouse`,`t`.`units` AS `units` from (`gb_plc_tags` `t` join `main_sites` `s` on((`s`.`id` = `t`.`site_id`))) where (`t`.`is_kpi` = 1) union select `t2`.`id` AS `id`,`s2`.`description` AS `site`,`t2`.`tag` AS `tag`,`t2`.`address` AS `address`,`t2`.`ui_label` AS `ui_label`,`t2`.`description` AS `description`,`t2`.`classification` AS `classification`,`t2`.`ehouse` AS `ehouse`,`t2`.`units` AS `units` from (`tl_plc_tags` `t2` join `main_sites` `s2` on((`s2`.`id` = `t2`.`site_id`))) where (`t2`.`is_kpi` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `gb_plc_production_fuel_view_Sum`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `gb_plc_production_fuel_view_Sum` AS (select distinct `gb_plc_production_fuel_view`.`id` AS `id`,`gb_plc_production_fuel_view`.`shift_id` AS `shift_id`,`gb_plc_production_fuel_view`.`fuel` AS `fuel` from `gb_plc_production_fuel_view` group by `gb_plc_production_fuel_view`.`id`,`gb_plc_production_fuel_view`.`shift_id`,`gb_plc_production_fuel_view`.`tons`,`gb_plc_production_fuel_view`.`fuel`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `qc_AllSitesLocationsView`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `qc_AllSitesLocationsView` AS select `l`.`id` AS `id`,`l`.`sort_order` AS `sort_order`,`s`.`id` AS `site_id`,`s`.`description` AS `site`,`p`.`id` AS `plant_id`,`p`.`name` AS `name`,`l`.`description` AS `description`,`l`.`is_split_sample_only` AS `is_split_sample_only`,`l`.`is_active` AS `is_active` from ((`gb_qc_locations` `l` join `main_sites` `s` on((`s`.`id` = `l`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `l`.`main_plant_id`))) union select `l`.`id` AS `id`,`l`.`sort_order` AS `sort_order`,`s`.`id` AS `site_id`,`s`.`description` AS `site`,`p`.`id` AS `plant_id`,`p`.`name` AS `name`,`l`.`description` AS `description`,`l`.`is_split_sample_only` AS `is_split_sample_only`,`l`.`is_active` AS `is_active` from ((`tl_qc_locations` `l` join `main_sites` `s` on((`s`.`id` = `l`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `l`.`main_plant_id`))) union select `l`.`id` AS `id`,`l`.`sort_order` AS `sort_order`,`s`.`id` AS `site_id`,`s`.`description` AS `site`,`p`.`id` AS `plant_id`,`p`.`name` AS `name`,`l`.`description` AS `description`,`l`.`is_split_sample_only` AS `is_split_sample_only`,`l`.`is_active` AS `is_active` from ((`wt_qc_locations` `l` join `main_sites` `s` on((`s`.`id` = `l`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `l`.`main_plant_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `gb_plc_production_fuel_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `gb_plc_production_fuel_view` AS (select `p`.`id` AS `id`,`p`.`shift_id` AS `shift_id`,`p`.`tons` AS `tons`,`p`.`product` AS `product`,(case when (`p`.`tag_id` in (275,276,277)) then `p`.`tons` end) AS `fuel`,`r`.`create_dt` AS `Date` from (`gb_plc_production` `p` join `gb_plc_runtime` `r` on((`r`.`shift_id` = `p`.`shift_id`))) order by `p`.`shift_id`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `qc_SievesByIsActiveView`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `qc_SievesByIsActiveView` AS select `stack`.`id` AS `id`,`stack`.`description` AS `description`,`stack`.`main_site_id` AS `main_site_id`,`stack`.`last_cleaned` AS `last_cleaned`,`stack`.`last_cleaned_by` AS `last_cleaned_by`,`stack`.`is_active` AS `is_active`,`stack`.`is_camsizer` AS `is_camsizer`,`stack`.`create_date` AS `create_date`,`stack`.`create_user_id` AS `create_user_id`,`stack`.`modify_date` AS `modify_date`,`stack`.`modify_user_id` AS `modify_user_id`,`site`.`description` AS `site`,`stack`.`sort_order` AS `sort_order` from (`gb_qc_sieve_stacks` `stack` join `main_sites` `site` on((`site`.`id` = `stack`.`main_site_id`))) union select `stack`.`id` AS `id`,`stack`.`description` AS `description`,`stack`.`main_site_id` AS `main_site_id`,`stack`.`last_cleaned` AS `last_cleaned`,`stack`.`last_cleaned_by` AS `last_cleaned_by`,`stack`.`is_active` AS `is_active`,`stack`.`is_camsizer` AS `is_camsizer`,`stack`.`create_date` AS `create_date`,`stack`.`create_user_id` AS `create_user_id`,`stack`.`modify_date` AS `modify_date`,`stack`.`modify_user_id` AS `modify_user_id`,`site`.`description` AS `site`,`stack`.`sort_order` AS `sort_order` from (`tl_qc_sieve_stacks` `stack` join `main_sites` `site` on((`site`.`id` = `stack`.`main_site_id`))) union select `stack`.`id` AS `id`,`stack`.`description` AS `description`,`stack`.`main_site_id` AS `main_site_id`,`stack`.`last_cleaned` AS `last_cleaned`,`stack`.`last_cleaned_by` AS `last_cleaned_by`,`stack`.`is_active` AS `is_active`,`stack`.`is_camsizer` AS `is_camsizer`,`stack`.`create_date` AS `create_date`,`stack`.`create_user_id` AS `create_user_id`,`stack`.`modify_date` AS `modify_date`,`stack`.`modify_user_id` AS `modify_user_id`,`site`.`description` AS `site`,`stack`.`sort_order` AS `sort_order` from (`wt_qc_sieve_stacks` `stack` join `main_sites` `site` on((`site`.`id` = `stack`.`main_site_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `qc_locationsView`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `qc_locationsView` AS select `g`.`description` AS `description`,`s`.`description` AS `site`,`p`.`description` AS `plant`,`g`.`is_split_sample_only` AS `is_split_sample_only`,`g`.`is_active` AS `is_active` from ((`gb_qc_locations` `g` join `main_sites` `s` on((`s`.`id` = `g`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `g`.`main_plant_id`))) union select `t`.`description` AS `description`,`s`.`description` AS `site`,`p`.`description` AS `plant`,`t`.`is_split_sample_only` AS `is_split_sample_only`,`t`.`is_active` AS `is_active` from ((`tl_qc_locations` `t` join `main_sites` `s` on((`s`.`id` = `t`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `t`.`main_plant_id`))) union select `w`.`description` AS `description`,`s`.`description` AS `site`,`p`.`description` AS `plant`,`w`.`is_split_sample_only` AS `is_split_sample_only`,`w`.`is_active` AS `is_active` from ((`wt_qc_locations` `w` join `main_sites` `s` on((`s`.`id` = `w`.`main_site_id`))) join `main_plants` `p` on((`p`.`id` = `w`.`main_plant_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-01-17 14:02:45
