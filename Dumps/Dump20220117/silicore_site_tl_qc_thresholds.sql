...
--
-- Table structure for table `tl_qc_thresholds`
--
...
--
-- Dumping data for table `tl_qc_thresholds`
--

LOCK TABLES `tl_qc_thresholds` WRITE;
/*!40000 ALTER TABLE `tl_qc_thresholds` DISABLE KEYS */;
/*!40000 ALTER TABLE `tl_qc_thresholds` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:53:09
