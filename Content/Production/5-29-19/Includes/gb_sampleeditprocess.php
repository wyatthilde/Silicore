...
/* * *****************************************************************************************************************************************
 * File Name: gb_sampleeditprocess.php
 * Project: Silicore
...
//plus 70
if(isset($_POST['plusSeventy']) > 0) 
{ 
  $plusSeventy = setValue(test_input($_POST['plusSeventy'])); 
  if($plusSeventy == "NA")
  {
    $plusSeventy = "0%";
  }
...
$plusSeventy = substr($plusSeventy, 0, -1); //remove the "%" from the value
$plusSeventy = $plusSeventy / 100; //convert back from a percent to a decimal


//plus 50
if(isset($_POST['plusFifty']) > 0) 
{ 
  $plusFifty = setValue(test_input($_POST['plusFifty'])); 
  if($plusFifty == "NA")
  {
    $plusFifty = "0%";
  }
...
$plusFifty = substr($plusFifty, 0, -1); //remove the "%" from the value
$plusFifty = $plusFifty / 100; //convert back from a percent to a decimal

//plus 40
if(isset($_POST['plusForty']) > 0) 
{ 
  $plusForty = setValue(test_input($_POST['plusForty'])); 
  if($plusForty == "NA")
  {
    $plusForty = "0%";
  }
...
$plusForty = substr($plusForty, 0, -1); //remove the "%" from the value
$plusForty = $plusForty / 100; //convert back from a percent to a decimal

//minus fifty plus one forty
if(isset($_POST['negFiftyPlusOneForty']) > 0) 
{ 
  $negFiftyPlusOneForty = setValue(test_input($_POST['negFiftyPlusOneForty'])); 
  if($negFiftyPlusOneForty == "NA")
  {
    $negFiftyPlusOneForty = "0%";
  }
} 
else 
{ 
...
$negFiftyPlusOneForty = substr($negFiftyPlusOneForty, 0, -1); //remove the "%" from the value
$negFiftyPlusOneForty = $negFiftyPlusOneForty / 100; //convert back from a percent to a decimal


//minus_40_plus_70
if(isset($_POST['negFortyPlusSeventy']) > 0) 
{ 
  $negFortyPlusSeventy = setValue(test_input($_POST['negFortyPlusSeventy'])); 
  if($negFortyPlusSeventy == "NA")
  {
    $negFortyPlusSeventy = "0%";
  }
} 
else 
{ 
...
$negFortyPlusSeventy = substr($negFortyPlusSeventy, 0, -1);
$negFortyPlusSeventy = $negFortyPlusSeventy / 100; //convert back from a percent to a decimal

//minus_70
if(isset($_POST['minusSeventy']) > 0) 
{ 
  $negSeventy = setValue(test_input($_POST['minusSeventy'])); 
  if($negSeventy == "NA")
  {
    $negSeventy = "0%";
  }
...
$negSeventy = substr($negSeventy, 0, -1);
$negSeventy = $negSeventy / 100; //convert back from a percent to a decimal

//minus_70_plus_140
if(isset($_POST['negSeventyPlusOneForty']) > 0) 
{ 
  $negSeventyPlusOneForty = setValue(test_input($_POST['negSeventyPlusOneForty'])); 
  if($negSeventyPlusOneForty == "NA")
  {
    $negSeventyPlusOneForty = "0%";
  }
} 
else 
{ 
...
$negSeventyPlusOneForty = substr($negSeventyPlusOneForty, 0, -1);
$negSeventyPlusOneForty = $negSeventyPlusOneForty / 100; //convert back from a percent to a decimal

//plus_140
//DEV NOTE: This field is not in the Sample Edit requirements. However it appeared on the Back Office QC Overview page.

//minus_140
if(isset($_POST['negOneForty']) > 0) 
{ 
  $negOneForty = setValue(test_input($_POST['negOneForty']));
  if($negOneForty == "NA")
  {
    $negOneForty = "0%";
  }
...
$negOneForty = substr($negOneForty , 0, -1);
$negOneForty = $negOneForty / 100; //convert back from a percent to a decimal
...
{
  $percentFinal1 = substr(test_input($_POST['percentFinal1']), 0, -1) / 100;
}

if(isset($_POST['percentFinal2']))
{
  $percentFinal2 = substr(test_input($_POST['percentFinal2']), 0, -1) / 100;
}

if(isset($_POST['percentFinal3']))
{
  $percentFinal3 = substr(test_input($_POST['percentFinal3']), 0, -1) / 100;
}

if(isset($_POST['percentFinal4']))
{
  $percentFinal4 = substr(test_input($_POST['percentFinal4']), 0, -1) / 100;
}

if(isset($_POST['percentFinal5']))
{
  $percentFinal5 = substr(test_input($_POST['percentFinal5']), 0, -1) / 100;
}

if(isset($_POST['percentFinal6']))
{
  $percentFinal6 = substr(test_input($_POST['percentFinal6']), 0, -1) / 100;
}

if(isset($_POST['percentFinal7']))
{
  $percentFinal7 = substr(test_input($_POST['percentFinal7']), 0, -1) / 100;
}

if(isset($_POST['percentFinal8']))
{
  $percentFinal8 = substr(test_input($_POST['percentFinal8']), 0, -1) / 100;
}

if(isset($_POST['percentFinal9']))
{
  $percentFinal9 = substr(test_input($_POST['percentFinal9']), 0, -1) / 100;
}

if(isset($_POST['percentFinal10']))
{
  $percentFinal10 = substr(test_input($_POST['percentFinal10']), 0, -1) / 100;
}

if(isset($_POST['percentFinal11']))
{
  $percentFinal11 = substr(test_input($_POST['percentFinal11']), 0, -1) / 100;
}

if(isset($_POST['percentFinal12']))
{
  $percentFinal12 = substr(test_input($_POST['percentFinal12']), 0, -1) / 100;
}

if(isset($_POST['percentFinal13']))
{
  $percentFinal13 = substr(test_input($_POST['percentFinal13']), 0, -1) / 100;
}

if(isset($_POST['percentFinal14']))
{
  $percentFinal14 = substr(test_input($_POST['percentFinal14']), 0, -1) / 100;
}

if(isset($_POST['percentFinal15']))
{
  $percentFinal15 = substr(test_input($_POST['percentFinal15']), 0, -1) / 100;
}

if(isset($_POST['percentFinal16']))
{
  $percentFinal16 = substr(test_input($_POST['percentFinal16']), 0, -1) / 100;
}

if(isset($_POST['percentFinal17']))
{
  $percentFinal17 = substr(test_input($_POST['percentFinal17']), 0, -1) / 100;
}

if(isset($_POST['percentFinal18']))
{
  $percentFinal18 = substr(test_input($_POST['percentFinal18']), 0, -1) / 100;
}
...
$currentSample = json_decode($db->get('sp_gb_qc_SampleGetByID("' . $sampleId . '");'));
...
//plus 70
$sampleObject->vars['plusSeventy'] = $plusSeventy;

//plus 50
$sampleObject->vars['plusFifty'] = $plusFifty;

//plus 40
$sampleObject->vars['plusForty'] = $plusForty;

//minus_50_plus_140
$sampleObject->vars['negFiftyPlusOneForty'] = $negFiftyPlusOneForty;

//minus_40_plus_70
$sampleObject->vars['negFortyPlusSeventy'] = $negFortyPlusSeventy;

//minus_70
$sampleObject->vars['negSeventy'] = $negSeventy;

//minus_70_plus_140
$sampleObject->vars['negSeventyPlusOneForty'] = $negSeventyPlusOneForty;

//plus_140
//DEV NOTE: This field is not in the Sample Edit requirements. However it appeared on the Back Office QC Overview page.

//minus_140
$sampleObject->vars['negOneForty'] = $negOneForty;
...
{
    $query = 'sp_gb_qc_SampleFinishDtCheck("' . $sampleId . '");';
...
$resultSample = json_decode($db->get('sp_gb_qc_SampleGetByID("' . $sampleId . '");'));

if(checkIfSampleIsComplete($sampleId) == 1) {
    $checkQuery = 'sp_gb_qc_SampleFinishDtCheck("' . $sampleId . '");';
    $finishDtResult = json_decode($db->get($checkQuery))[0]->finish_dt;

    if ($finishDtResult == null || $finishDtResult == '') {
        $updateQuery = 'sp_gb_qc_SampleFinishDtUpdate("' . $sampleId . '");';
        $db->insert($updateQuery);
    }
}

if($resultSample[0]->is_complete == 1) {
    $db->insert('sp_gb_qc_sample_repeat_unlock("' . $sampleId . '");');
}
...
if($result == 1)
{
    if($isCOA == 1) {
        if($userPermissionsArray['vista']['granbury']['qc'] > 3) {
            ...
            header('Location: ../../Controls/QC/gb_samples.php?view=summary&completionStatus=Incomplete&void=A');
        }
...
else
{
  ...
  //header('Location: ../../Controls/QC/gb_sampleedit.php?sampleId=' . $sampleId);
}
