...
//include other files
require_once('../../Includes/QC/wt_qcfunctions.php'); //contains qc database functions
...
else
{
    ...
    if(($userIsLabTech == 1) && ($userPermissionsArray['vista']['west_texas']['qc'] < 3))
    {
        //read the data for the cycles table
...
<div id="qc_groups" class="tabcontent">
    ...
    <div class="form-group">
        ...
        <select id="lab_tech_filter" name="lab_tech_filter" onchange="reloadPage();" required>
            ...
            foreach ($userObjectArray as $userObject)
            {
                ...
                {
                    if(($user_id != $userObject->vars["id"]) && ($userPermissionsArray['vista']['west_texas']['qc'] < 3))
                    {
                        //do nothing
                    }
                    else
    ...
    <table class='table table-bordered table-striped table-responsive'>
        ...
        <tr><th>Plant</th><th>Lab Tech</th><th>Tests</th><th>Avg Hrs (Tests)</th><th>Retests</th><th>Misc Tests</th><th>Calibration Tests</th><th>Repeatability Tests</th><th>Resample Tests</th></tr>
        </thead>
        <tbody>
...
<script type="text/javascript">
    function reloadPage()
    {
        ...
        window.location='wt_performance.php?startDate=' + startDate + '&endDate=' + endDate + '&labTech=' + labTech;
    }
</script>
<?php
$previousDate = NULL;
