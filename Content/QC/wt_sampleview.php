                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" name='siteId' id='siteId'
                                    ...
                                    if ($userPermissionsArray['vista']['west_texas']['qc'] < 2) {
                                        echo "<option value='60' selected='selected'>West Texas</option>"; //DEV NOTE: hardcoded values; these should be changed if the database info is not static
                                    ...
                                    } else //the user has permission to change this
                                    {
                                        ...
                                        foreach ($siteObjectArray as $siteObject) {
                                            ...
                                            {
                                                if ($siteObject->vars["id"] == "60") //match the site to tolar
                                                {
...
<script>
    ...
    function loadSpecificLocationSelect() {
        ...
        function getPlantSettings() {
            ...
            if (plantId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/wt_plantsettingsinputfieldsreadonly.php?plantId=" + plantId + "&sampleId=" +<?php echo $sampleId; ?>, true);
                xmlhttp2.send();
    ...
    function updateOrePercent() {
        ...
        function enableDisableWetWeights() {
            ...
            if (locationId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/wt_locationcheckwetweightsforreadonly.php?locationId=" + locationId, true);
                xmlhttp2.send();
    ...
    function changeBlankSieveRangesToNA() {
        ...
        if (siteIDSelected != 60) //DEV NOTE: This site ID is hard coded and should be changed for new mine sites. 10 = tolar; 50 = Tolar
        {
