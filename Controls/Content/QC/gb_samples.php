 ...
 * 06/26/2017|mnutsch|KACE:xxxxx - Updated content
 * 07/05/2017|mnutsch|KACE:17366 - Add functionality for when there are no search results.
 * 07/17/2017|mnutsch|KACE:17366 - Added functionality around user repeatability.
 * 07/18/2017|mnutsch|KACE:17366 - Added functionality around summary and verbose views.
 * 07/19/2017|mnutsch|KACE:17366 - Updated the default View filter and other changes.
 * 07/20/2017|mnutsch|KACE:17366 - Added CSV download functionality.
 * 07/20/2017|mnutsch|KACE:17366 - Added void filter functionality.
 * 07/25/2017|mnutsch|KACE:17366 - Debugged errors with imported data.
 * 08/01/2017|mnutsch|KACE:17693 - Debugged error with datetime filtering.
 * 08/11/2017|mnutsch|KACE:17916 - Updated the default date range
 * 08/14/2017|mnutsch|KACE:xxxxx - Commented out tablesorter JavaScript reference.
 * 08/15/2017|kkuehn|KACE:xxxxx - reverted all references to vprop back to vista
 * 08/16/2017|mnutsch|KACE:17957 - changed Total Weight to a Verbose only viewed column.
 * 08/18/2017|mnutsch|KACE:17957 - Fixed an issue where the timer counts down from 60 minutes on the Samples page, but 180 minutes on other pages.
 * 08/21/2017|mnutsch|KACE:17957 - Added additional fields to the table in Verbose view. Also added permission specific hyperlinks.
 * 08/24/2017|mnutsch|KACE:17957 - Changed the sieve range names from numeric to text based.
 * 08/28/2017|mnutsch|KACE:17957 - Added pagination to the Samples page.
 * 08/31/2017|mnutsch|KACE:17957 - Updated format of percentages in table.
 * 08/31/2017|mnutsch|KACE:17957 - Updated Ore Percent.
 ...
 * 09/26/2017|mnutsch|KACE:17957 - Added code for multi-select filters.
  ...
  <div class="samplesTableWrapperBox">
    <div class="tableWrapper">
      ...
      else 
      {
        ...
        "<th class='verbose'>Specific Location ID</th>";
        ...
        */      
        ...
        foreach ($ObjectArray as $Object) 
        {
          ...
          "<td title='Sample ID'><a href='../../Controls/QC/gb_sampleview.php?sampleId=" . $Object->vars["id"] . "'>" . $Object->vars["id"] . "</a></td>" .  //summary field
          ...
          */
          ...
          if(isset($userPermissionsArray['vista']['granbury']['qc']))
          {
            if($userPermissionsArray['vista']['granbury']['qc'] > 0) //if the user has a QC permission then show them the void link
            {
              ...
              {
                //if the user has permission to unvoid samples, then show them the think
                if(isset($userPermissionsArray['vista']['granbury']['qc']))
                {
                  if($userPermissionsArray['vista']['granbury']['qc'] >= 3) 
                  {
