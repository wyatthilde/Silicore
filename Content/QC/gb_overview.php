...
function renderSpecificLocationBox($argSpecificLocationID, $argStartDate, $argEndDate, $argPlantID)
{
  ...
  if($argSpecificLocationID != "")
  {
    ...
    if($sampleObject != NULL)
    {
      ...
      "<tr><th colspan='2' class='sectionTitle'>Latest Sample ID: <a href='gb_sampleview.php?sampleId=" . $sampleId . "' target='_blank'>" . $sampleId . "</a>".             
        "<br/>Date Time: " . 
      ...
      echo ("<script> console.log(" . print_r($arrayOfDateRangeAverages) . ") </script>");
...
if(isset($_GET['siteId']))
{
  ...
  if($siteId == "")
  {
    //if the siteId parameter received is empty, then default it to Granbury (ID # 10)
    $siteId = 10;
  }
}
else 
{
  //if there isn't a siteId parameter received, then default it to Granbury (ID # 10)
  $siteId = 10;
}
...
function reloadPage()
{
  ...
  window.location.replace("gb_overview.php?siteId=" + siteId + "&plantId=" + plantId + "&startDate=" + startDate + "&endDate=" + endDate);
}
