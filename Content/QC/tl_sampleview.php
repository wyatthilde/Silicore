...
<div class="container" style="max-width:85%;">
    ...
    <form id="qcForm" name="qcForm" action="" onsubmit="return validateForm()"
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" name='siteId' id='siteId'
                                        onchange='loadPlantSelect();loadSieveStackSelect(); confirmSite();' disabled>
                                    <?php
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <input type="text" class="form-control" id="dt" name="dt"
                                       ...
                                       } ?>" onchange="updateDateTimeSpan();" disabled>
                            </div>
                            <div class="form-group col-lg-2"></div>
                            <div class="form-group col-lg-2">
                                <label for="labTech">Lab Tech:</label>
                                <select class="form-control" id="labTech" name="labTech" disabled>
                                    <?php
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" id="sampler" name="sampler" disabled>
                                    <option value=""></option>
                                    <?php
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" id="operator" name="operator" disabled>
                                    <option value=""></option>
                                    <?php
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" id="testTypeId" name="testTypeId" disabled>
                                    <option value=""></option>
                                    <?php
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" id="compositeTypeId" name="compositeTypeId" disabled>
                                    <option value=""></option>
                                    <?php
                            ...
                            <div class="form-group col-lg-2" id="beginningWetWeightWrapper">
                                ...
                                <input class="form-control" type="number" step="0.1" max="99999" id="beginningWetWeight"
                                       ...
                                       onchange="setLostValues(); updateMoistureRate();" disabled>
                            </div>
                            <div class="form-group col-lg-2" id="preWashDryWeightWrapper">
                                ...
                                <input class="form-control" type="number" step="0.1" max="99999" id="preWashDryWeight"
                                       ...
                                       onchange="setLostValues(); updateMoistureRate(); updateOrePercent(); updateOversizePercent();" disabled>
                            </div>
                            <div class="form-group col-lg-2" id="postWashDryWeightWrapper">
                                ...
                                <input class="form-control" type="number" step="0.1" max="99999" id="postWashDryWeight"
                                       ...
                                       onchange="setLostValues(); updateMoistureRate(); updateOrePercent();" disabled>
                            </div>
                            <div class="form-group col-lg-2">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0" id="oversizeWeight"
                                       ...
                                       onChange="updateOversizePercent(); setLostValues();updateOrePercent(); calculateRates();" disabled>

                            </div>
                            <div class="form-group col-lg-2">
                                <label for="oversizePercent">Oversize Percent:</label>
                                <input class="form-control" type="text" id="oversizePercent" name="oversizePercent" disabled>
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <input class="form-control" type="text" id="gramsLost" name="gramsLost" disabled>
                            </div>
                            <div class="form-group col-lg-2">
                                <label for="percentLost" id="percentLostLabel">Slimes %:</label>
                                <input class="form-control" type="text" id="percentLost" name="percentLost" disabled>
                            </div>
                            <div class="form-group col-lg-2">
                                <label for="newSplit" id="newSplitLabel">New Split Weight:</label>
                                <input class="form-control" type="text" id="newSplit" name="newSplit" disabled>
                            </div>
                            <div class="form-group col-lg-2">
                                        ...
                                        if ($sampleObject->vars['isComplete'] == 1) {
                                            if (isset($sampleObject->vars['isCOA'])) {
                                                if ($sampleObject->vars['isCOA'] == 1) {
                                                    echo("<input type='checkbox' class='form-check-input' id='isCOA' name='isCOA' type='isCOA' value='1' disabled>");
                ...
                <div class="container rounded-0 border-left border-right bg-white">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <select name="kValue" id="kValue" class="form-control " onChange="showCurrentKValueGroup();" disabled>
                                <?php
...
<script>
    ...
    function checkIfCoreSample() {
        ...
        function loadSieveStackSelect() {
            ...
            if (siteID.length > 0) {
                ...
                ?>
                xmlhttp2.open("GET", "../../Includes/QC/tl_sievestacksselectbysitereadonly.php?siteID=" + siteID + "&sieveStackID=" +<?php echo $sampleObject->vars['sieveMethod']; ?>, true);
                xmlhttp2.send();
        ...
        if (siteId.length > 0) {
            ...
            xmlhttp2.onreadystatechange = function () {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_plantsselectbysitereadonly.php?siteId=" + siteId + "&plantId=" +<?php echo $sampleObject->vars['plantId']; ?>, true);
                xmlhttp2.send();
        ...
        function loadLocationSelect() {
            ...
            if (plantId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_locationsselectbyplantreadonly.php?plantId=" + plantId + "&locationId=" +<?php echo $sampleObject->vars['location']; ?>, true);
                xmlhttp2.send();
    ...
    function loadSpecificLocationSelect() {
        //enableDisableWetWeights();
            ...
            if (locationId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_specificlocationsselectbylocationreadonly.php?locationId=" + locationId + "&specificLocationId=" +<?php echo $sampleObject->vars['specificLocation']; ?>, true);
                xmlhttp2.send();
        ...
        function getSieves() {
            ...
            if (sieveStackId != null) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_sievesgetreadonly.php?stackId=" + sieveStackId + "&sampleId=" +<?php echo $sampleId; ?>, true);
                xmlhttp2.send();
        ...
        function getPlantSettings() {
            ...
            if (plantId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_plantsettingsinputfieldsreadonly.php?plantId=" + plantId + "&sampleId=" +<?php echo $sampleId; ?>, true);
                xmlhttp2.send();
    ...
    function updateOrePercent() {
        ...
        function enableDisableWetWeights() {
            ...
            if (locationId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/tl_locationcheckwetweightsforreadonly.php?locationId=" + locationId, true);
                xmlhttp2.send();
    ...
    function setFinalPercentsAndRanges(sieveCount) {
        for (let x = 1; x < sieveCount; x++) {
            ...
            if(screenSize.val() <= 40) sieveValues['neg10Plus40'] += parseFloat(percentFinal);
    ...
    function setRangesToForm() {
        $('#neg10Plus40').val(sieveValues['neg10Plus40'].toFixed(2));
    ...
    function changeBlankSieveRangesToNA() {
        ...
        var neg10Plus40 = document.getElementById('neg10Plus40');
        ...
        if (neg10Plus40.value == "0.00%") {
            neg10Plus40.value = "NA";
        }
        ...
        if (siteIDSelected != 10) //DEV NOTE: This site ID is hard coded and should be changed for new mine sites. 10 = tolar; 50 = Tolar
        {
            confirm("The Site is not set to tolar. Are you sure?"); //DEV NOTE: This text is hard coded and should be changed for new mine sites
        }
    }
