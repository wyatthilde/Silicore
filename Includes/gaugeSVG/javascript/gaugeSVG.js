...
// @return:      instance: [SilicoreGauge] The initialize  gauge instance.
...
SilicoreGauge = function(params)
{ 
	// Check prerequisits.
	if (!params.id)
	{
		alert ("Missing parameter 'params.id' for SilicoreGauge.");
		return undefined;
	}
	...
	this.config = {
		...
		titleColor: (params.titleColor != undefined) ? params.titleColor : "#4C7AD0",
		...
		minmaxColor: (params.minmaxColor != undefined) ? params.minmaxColor : "#4C7AD0",
		
		// The background color of the gauge canvas. Default is "#f8f8f8".
		canvasBackColor: (params.canvasBackColor != undefined) ? params.canvasBackColor : "#FFF",
		...
		gaugeBorderColor: (params.gaugeBorderColor != undefined) ? params.gaugeBorderColor : "#000000",
		...
		gaugeBackColor: (params.gaugeBackColor != undefined) ? params.gaugeBackColor : "#003087",
		...
		// The width of the canvas, defined by its parent DIV element.
		canvasW: container.style.pixelWidth  || container.offsetWidth,
		
		// The Height of the canvas, defined by its parent DIV element.
		...
		// The gauge needle color. Default is "#000000".
		needleColor: (params.needleColor != undefined) ? params.needleColor : "#000000",
		
		// The optimum range color. Default is "#78D64B".
		optimumRangeColor: (params.optimumRangeColor != undefined) ? params.optimumRangeColor : "#78D64B",
		
		// The warning range color. Default is "#FFCC00".
		warningRangeColor: (params.warningRangeColor != undefined) ? params.warningRangeColor : "#FFCC00",
		
		// The action range color. Default is "#FF0000".
...
if (this.config.showGaugeShadow == true)
{
	...
	this.grad1sub2.setAttributeNS(null, 'offset', this.config.gaugeShadowScale * 0 + "%");
	this.grad1sub2.setAttributeNS(null, 'style', "stop-color:" + this.config.gaugeBackColor + ";stop-opacity:0");
...
// @param:       gaugeSVG [SilicoreGauge]: The gauge to perform value step animation on.
