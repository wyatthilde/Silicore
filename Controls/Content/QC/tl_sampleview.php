 ...
 * 09/12/2017|mnutsch|KACE:17959 - Corrected file references
 ...
 * 11/17/2017|mnutsch|KACE:xxxxx - Fixed links to point to Tolar pages instead of Granbury pages.
...
{
  echo "<script type=\"text/javascript\">window.location = \"../../Controls/QC/tl_samples.php?void=A&view=verbose&completionStatus=1\";</script>"; //using JS, because output is already sent in header.php
}
else
{
...
<div id="qc_general" class="tabcontent">
  ...
  <div class="sieveAreaSampleDetail">
    ...
    <button class="qcButtons" type="button" onclick="location.href = '../../Controls/QC/tl_samples.php?void=A&view=summary';">Back</button>
...
function getSieves()
{
  ...
  if(sieveStackId != null)
  {
    ...
    xmlhttp2.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
        document.getElementById("sieveSelect").innerHTML = this.responseText; //display the tl_sievesget.php output inside sampleedit.php
