...
/*
//DEV NOTE: This was added instead of Including/Requiring pagevariables.php, because Including/Requiring pagevariables.php did not seem to work.
...
echo "ServerSubDomain = " . $ServerSubDomain . "<br/>";
 ...
 ************************************************************************************************/
function SendPHPMail($argEmailAddresses, $argSubject, $argBody, $argSource = "", $argDebugging = 1, $argTextOnly = 0)
{  
