...
--
-- Table structure for table `prod_auto_plant_analog_data_dryer_temp`
--
...
--
-- Dumping data for table `prod_auto_plant_analog_data_dryer_temp`
--

LOCK TABLES `prod_auto_plant_analog_data_dryer_temp` WRITE;
/*!40000 ALTER TABLE `prod_auto_plant_analog_data_dryer_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `prod_auto_plant_analog_data_dryer_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-01-17 13:52:31
