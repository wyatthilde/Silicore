 ...
 * 01/10/2018|mnutsch|KACE:xxxxx - Corrected a snippet of code to look at Tolar permission instead of west_texas.
      ...
      //Display the Verbose version of the table.
            ...
            foreach ($ObjectArray as $Object)
            {
              ...
              if($neg140 != 0) { $neg140 = ($neg140 * 100) . "%"; } else { $neg140 = ""; }
                ...
                echo "<tr>" .
                    "<td class='leftCol2' title='Sample ID'><a href='../../Controls/QC/wt_sampleview.php?sampleId=" . $Object->vars["id"] . "'>" . $Object->vars["id"] . "</a></td>" .
...
<script>
    ...
    function idSearch()
    {
        ...
        window.location = "wt_sampleedit.php?sampleId=" + idInput;
    }
...
//            }
    ...
    {
        window.location = "/Controls/QC/wt_samples.php";
    }
