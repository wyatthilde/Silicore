...
CREATE TABLE `hr_applicants` (
  ...
  `hr_division_id` int(11) NOT NULL,
  `hr_site_id` int(11) NOT NULL,
  `hr_applicant_status_code_id` int(11) NOT NULL DEFAULT '1',
  `create_user_id` int(11) NOT NULL,
  `create_date` datetime NOT NULL,
  `modify_user_id` int(11) DEFAULT NULL,
  `modify_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `hr_division_id` (`hr_division_id`),
  KEY `hr_site_id` (`hr_site_id`),
  CONSTRAINT `hr_applicants_ibfk_1` FOREIGN KEY (`hr_division_id`) REFERENCES `hr_divisions` (`id`),
  CONSTRAINT `hr_applicants_ibfk_2` FOREIGN KEY (`hr_site_id`) REFERENCES `hr_sites` (`id`)
...
-- Dump completed on 2022-01-17 14:01:45
