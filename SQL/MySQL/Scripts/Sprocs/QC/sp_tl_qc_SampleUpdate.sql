/*******************************************************************************************************************************************
 * File Name: sp_tl_qc_SampleUpdate.sql
 * Project: Silicore
 * Description: 
 * Notes:
 * =========================================================================================================================================
 ...
 * 10/05/2017|mnutsch|KACE:17957 - Added Parameters
 * 11/15/2017|mnutsch|KACE:18470 - Added isCOA parameter.
 * 01/26/2018|mnutsch|KACE:20305 - Added Near Size parameter.
 * 
 ******************************************************************************************************************************************/

DROP PROCEDURE IF EXISTS sp_tl_qc_SampleUpdate;

DELIMITER $$

CREATE DEFINER=`root`@`localhost` PROCEDURE sp_tl_qc_SampleUpdate
(
    IN p_id INT(11),
