...
if(isset($_GET['screenNew']) && strlen($_GET['screenNew']) > 0)
{
  ...
  //echo "Threshold Screen: " . $thresholdScreen . "<br>";
}
else
{
  $allValuesPresent = 0;
...
if(isset($_GET['locationNew']) && strlen($_GET['locationNew']) > 0)
{
  ...
  //echo "New Location: " . $thresholdLocation . "<br>";
}
else
{
  $allValuesPresent = 0;
...
if(isset($_GET['lowThresholdNew']) && strlen($_GET['lowThresholdNew']) > 0)
{
  ...
  //echo "Low Threshold: " . $thresholdLow . "<br>";
}
else
{
  $allValuesPresent = 0;
...
if(isset($_GET['highThresholdNew']) && strlen($_GET['highThresholdNew']) > 0)
{
  ...
  //echo "Threshold High: " . $thresholdHigh . "<br>";
}
else
{
  $allValuesPresent = 0;
...
header('Location: ../../Controls/QC/tl_thresholdmaint.php');
