...
echo('<select id="locationId" name="locationId" class="form-control" onchange="loadSpecificLocationSelect(); updateCoreSampleFieldVisibility(); getSieves(); updateLocationSpan();">');
