 ...
 * =========================================================================================================================================
 * 02/27/2019|nolliff|KACE:xxxxx - Initial creation
 *
 * **************************************************************************************************************************************** */
...
//  print_r ($obj);
  ...
  $first_name = test_input($obj["first_name"]);
  $last_name = test_input($obj["last_name"]);
  $email_address = test_input($obj["email_address"]);
  $company = test_input($obj["company"]);
  $department = test_input($obj["department"]);
  $accessLevel = test_input($obj["accessLevel"]);
...
//    echo "<h3>Inserting a new User Into Database</h3>";
  ...
  {
    echo json_encode("No information posted");
  }
