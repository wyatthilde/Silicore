    ...
    function checkIfCoreSample() {
        ...
        function loadSieveStackSelect() {
            ...
            if (siteID.length > 0) {
                ...
                ?>
                xmlhttp2.open("GET", "../../Includes/QC/gb_sievestacksselectbysitereadonly.php?siteID=" + siteID + "&sieveStackID=" +<?php echo $sampleObject->vars['sieveMethod']; ?>, true);
                xmlhttp2.send();
        ...
        if (siteId.length > 0) {
            ...
            xmlhttp2.onreadystatechange = function () {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_plantsselectbysitereadonly.php?siteId=" + siteId + "&plantId=" +<?php echo $sampleObject->vars['plantId']; ?>, true);
                xmlhttp2.send();
        ...
        function loadLocationSelect() {
            ...
            if (plantId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_locationsselectbyplantreadonly.php?plantId=" + plantId + "&locationId=" +<?php echo $sampleObject->vars['location']; ?>, true);
                xmlhttp2.send();
    ...
    function loadSpecificLocationSelect() {
        //enableDisableWetWeights();
            ...
            if (locationId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_specificlocationsselectbylocationreadonly.php?locationId=" + locationId + "&specificLocationId=" +<?php echo $sampleObject->vars['specificLocation']; ?>, true);
                xmlhttp2.send();
        ...
        function getSieves() {
            ...
            if (sieveStackId != null) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_sievesgetreadonly.php?stackId=" + sieveStackId + "&sampleId=" +<?php echo $sampleId; ?>, true);
                xmlhttp2.send();
        ...
        function getPlantSettings() {
            ...
            if (plantId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_plantsettingsinputfieldsreadonly.php?plantId=" + plantId + "&sampleId=" +<?php echo $sampleId; ?>, true);
                xmlhttp2.send();
    ...
    function updateOrePercent() {
        ...
        function enableDisableWetWeights() {
            ...
            if (locationId.length > 0) {
                ...
                //get the content
                xmlhttp2.open("GET", "../../Includes/QC/gb_locationcheckwetweightsforreadonly.php?locationId=" + locationId, true);
                xmlhttp2.send();
